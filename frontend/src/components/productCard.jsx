...
export default function ProductCard({ image, category, name, rating, ratingCount, brand, price, discount, sale, className }) {
  return (
    <div className={cn("shadow-sm flex justify-center items-center flex-col w-60 rounded-xl border p-2 relative", className)}>
      ...
      <div className="rounded-xl border-2 w-40 m-10">
      ...
      <div className="py-2 w-full flex justify-center items-center flex-col ">
        ...
        <span className="w-full"><span className="text-gray-500">By</span> <span className="text-green-500">{brand}</span></span>
        ...
        <div className="flex justify-around items-center w-full">
          ...
          <Button variant="outline" className='bg-green-200 rounded-sm text-green-800'><ShoppingBag /><span>Add</span></Button>
        </div>
